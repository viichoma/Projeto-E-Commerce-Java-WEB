...
INSERT INTO `produto` (`CD_PRODUTO`, `DS_NOME`, `DS_PRODUTO`, `VL_PRECO`, `DS_TAMANHO`, `DS_CATEGORIA`, `DS_GENERO`, `QT_QUANTIDADE`, `DS_IMG`) VALUES
	...
	(18, 'T̻nis 00s Campus', 'T̻nis Adidas Campus 00s', 699, 'M', 'Sapato', 'U', 123, 'https://acdn.mitiendanube.com/stores/002/859/419/products/7-3e5c34e8a59c595ebe17052503687982-1024-1024.webp');
...
-- Copiando dados para a tabela projetojava.usuario: ~2 rows (aproximadamente)
